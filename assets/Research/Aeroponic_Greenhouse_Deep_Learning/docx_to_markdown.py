"""
Convert DOCX to Markdown for Aeroponic Greenhouse / ASABE 2021 paper.
Output: Markdown/azdez.asp.md and Markdown/media/
"""
import subprocess
import re
...
DOCX_PATH = REPO_ROOT / "DOCX" / "azdez.asp.docx"
MARKDOWN_DIR = REPO_ROOT / "Markdown"
MEDIA_DIR = MARKDOWN_DIR / "media"
OUTPUT_MD = MARKDOWN_DIR / "azdez.asp.md"
